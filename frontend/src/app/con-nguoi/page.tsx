...
const organizations = [
  ...
  {
    name: "Chi hội phụ nữ",
    img: "/images/tapthechihoiphunu.jpg",
    hasTextOnImage: true,
    details: {
      leader: { name: "Đang cập nhật...", role: "Trưởng phòng", img: "/images/logo-viettel-store.png?v=clear" },
      group: { name: "Chi hội phụ nữ", subName: "Viettel Store", img: "/images/tapthechihoiphunu.jpg" },
      deputies: [],
      layoutOnMain: "page2-special",
      mainItems: [
        { img: "/images/chihoiphunu/1.jpg", name: "", role: "", objectPosition: "center center" },
        { img: "/images/chihoiphunu/2.jpg", name: "", role: "" },
        { img: "/images/chihoiphunu/3.jpg", name: "", role: "" },
        { img: "/images/chihoiphunu/4.jpg", name: "", role: "" }
      ]
    }
  },
  {
    ...
    <>
        ...
        <div className="relative z-10 w-full pt-0">
          ...
          <section className="py-24 bg-[#F2F2F2] relative w-full overflow-hidden">
            ...
            <RipplePattern 
              ...
              style={{ top: '5%', left: '8%', width: '280px', height: '280px', opacity: 0.25 }} 
            />
            <RipplePattern 
              className="absolute z-0" 
              style={{ top: '45%', right: '-5%', width: '320px', height: '320px', opacity: 0.2 }} 
            />
            <RipplePattern 
              className="absolute z-0" 
              style={{ bottom: '10%', left: '15%', width: '180px', height: '180px', opacity: 0.15 }} 
            />
          ...
          <section className="py-24 bg-[#F2F2F2] relative w-full overflow-hidden">
            ...
            <RipplePattern 
              className="absolute z-0" 
              style={{ top: '10%', right: '12%', width: '250px', height: '250px', opacity: 0.22 }} 
            />
            <RipplePattern 
              className="absolute z-0" 
              style={{ top: '55%', left: '-8%', width: '350px', height: '350px', opacity: 0.18 }} 
            />
            <RipplePattern 
              className="absolute z-0" 
              style={{ bottom: '5%', right: '20%', width: '200px', height: '200px', opacity: 0.2 }} 
            />

            <div className="container mx-auto px-4 relative z-10 max-w-[1500px]">
              <h2 className="text-[#4A4A4A] font-beausans font-black text-4xl md:text-5xl uppercase mb-16 text-center tracking-tight">
                ĐẢNG BỘ BỘ PHẬN VÀ<br />CÁC TỔ CHỨC QUẦN CHÚNG
              </h2>
              ...
              <div className="flex items-center justify-center gap-4 md:gap-12 w-full max-w-[1700px] mx-auto relative px-4">
                ...
                <div className="flex-1 relative overflow-hidden py-4">
                  ...
                  >
                    {Array.from({ length: Math.ceil(organizations.length / 4) }).map((_, pageIdx) => (
                      <div key={pageIdx} className="w-full shrink-0 px-1 md:px-2">
                        <div className="grid grid-cols-2 gap-4 md:gap-4 w-full">
                          {organizations.slice(pageIdx * 4, pageIdx * 4 + 4).map((org, idx) => (
                            <div
                              key={idx}
                ...
                {/* Right Arrow */}
                <button
                  onClick={() => setActiveBranchPage(p => (p + 1) * 4 < organizations.length ? p + 1 : p)}
                  className="shrink-0 w-12 h-12 md:w-20 md:h-20 bg-white/90 backdrop-blur-md rounded-full flex items-center justify-center shadow-2xl border border-white/50 hover:bg-[#EE0033] group transition-all duration-500 z-30"
                >
                  <ChevronRight size={32} className="text-gray-800 group-hover:text-white transition-colors duration-500" />
                </button>
                      ...
                      >
                        <div className="relative w-full h-full flex flex-col items-center justify-center">
                          ...
                          <img
                            ...
                            alt={prov.name}
                            className={`absolute w-[90%] h-[90%] object-contain pointer-events-none transition-all duration-700 ${isCenter ? "opacity-100 scale-110" : "opacity-100 scale-90"}`}
                          />
                        </div>
                      </div>
                    );
      ...
      {selectedProvince && (
        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-y-12 md:gap-y-20 w-full animate-in fade-in zoom-in-95 duration-500 delay-0">
              ...
              >
                ...
                <AnimatePresence initial={false} custom={slideDirection}>
                  <motion.img
                    ...
                    custom={slideDirection}
                    variants={{
                      enter: (direction: number) => ({ opacity: 0, x: direction > 0 ? 300 : -300, scale: 1.05 }),
                      center: {
                        opacity: 1, x: 0, scale: (() => {
                      ...
                      exit: (direction: number) => ({ opacity: 0, x: direction < 0 ? 300 : -300, scale: 1.05 })
                    }}
                    initial="enter"
                    animate="center"
                    exit="exit"
