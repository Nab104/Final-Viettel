        ...
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-y-16 gap-x-8 relative z-10">
              {[
                { year: '2006', image: '/images/journey/milestones/2006.jpeg', desc: 'Thành lập Hệ thống bán lẻ Viettel' },
                { year: '2009', image: '/images/journey/milestones/2009.jpeg', desc: 'Mở rộng chuỗi cửa hàng toàn quốc' },
                { year: '2015', image: '/images/journey/milestones/2015.jpeg', desc: 'Ra mắt nhận diện thương hiệu Viettel Store' },
                { year: '2018', image: '/images/journey/milestones/2018.png', desc: 'Đạt mốc 300 siêu thị' },
                { year: '2020', image: '/images/journey/milestones/2020.jpg', desc: 'Đẩy mạnh chuyển đổi số & thương mại điện tử' },
                { year: '2024', image: '/images/journey/milestones/2024.jpg', desc: 'Hơn 400 siêu thị, phục vụ hàng triệu khách hàng' }
              ].map((item, idx) => (
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              '/images/trophies/cup-1.png',
              '/images/trophies/cup-2.png',
              '/images/trophies/cup-3.png',
              '/images/trophies/cup-4.png'
            ].map((img, idx) => (
